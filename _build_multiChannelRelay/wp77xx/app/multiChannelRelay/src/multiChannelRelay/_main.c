...
// Startup code for the executable 'multiChannelRelay'.
...
LE_SHARED const char* _multiChannelRelayComponent_multiChannelRelay_ServiceInstanceName = "multiChannelRelay";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t multiChannelRelay_exe_LogSession;
LE_SHARED le_log_Level_t* multiChannelRelay_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    multiChannelRelay_exe_LogSession = log_RegComponent("multiChannelRelay_exe", &multiChannelRelay_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_multiChannelRelayComponent.so");
