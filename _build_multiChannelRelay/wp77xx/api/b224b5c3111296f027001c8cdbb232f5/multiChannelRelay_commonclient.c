 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(multiChannelRelay_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(multiChannelRelay_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(multiChannelRelay_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(multiChannelRelay_ClientHandlers,
                                                  HIGH_CLIENT_DATA_COUNT);
        }
...
)
{
    ...
    _msgPtr->id = _MSGID_multiChannelRelay_turn_off_channel;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_multiChannelRelay_turn_on_channel;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_multiChannelRelay_getChannelState;
    _msgBufPtr = _msgPtr->buffer;
    ...
    if (!le_pack_UnpackUint8( &_msgBufPtr, &_result ))
    {
        goto error_unpack;
    }
