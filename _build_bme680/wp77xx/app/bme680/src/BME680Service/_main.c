...
// Startup code for the executable 'BME680Service'.
...
LE_SHARED const char* _BME680Component_io_ServiceInstanceName = "BME680Service.BME680Component.io";
LE_SHARED const char* _BME680Component_admin_ServiceInstanceName = "BME680Service.BME680Component.admin";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t BME680Service_exe_LogSession;
LE_SHARED le_log_Level_t* BME680Service_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    BME680Service_exe_LogSession = log_RegComponent("BME680Service_exe", &BME680Service_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_i2c_utils.so");
    LoadLib("libComponent_BME680Component.so");
