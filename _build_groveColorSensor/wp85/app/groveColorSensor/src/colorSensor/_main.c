...
// Startup code for the executable 'colorSensor'.
...
LE_SHARED le_log_SessionRef_t colorSensor_exe_LogSession;
LE_SHARED le_log_Level_t* colorSensor_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    colorSensor_exe_LogSession = log_RegComponent("colorSensor_exe", &colorSensor_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_groverColorComponent.so");
