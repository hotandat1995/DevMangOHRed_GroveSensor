...
// Startup code for the executable 'MonitorRelayDataHub'.
...
LE_SHARED const char* _MonitorRelayDataHubComponent_le_avdata_ServiceInstanceName = "MonitorRelayDataHub.MonitorRelayDataHubComponent.le_avdata";
LE_SHARED const char* _MonitorRelayDataHubComponent_io_ServiceInstanceName = "MonitorRelayDataHub.MonitorRelayDataHubComponent.io";
LE_SHARED const char* _MonitorRelayDataHubComponent_admin_ServiceInstanceName = "MonitorRelayDataHub.MonitorRelayDataHubComponent.admin";
LE_SHARED const char* _MonitorRelayDataHubComponent_multiChannelRelay_ServiceInstanceName = "MonitorRelayDataHub.MonitorRelayDataHubComponent.multiChannelRelay";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t MonitorRelayDataHub_exe_LogSession;
LE_SHARED le_log_Level_t* MonitorRelayDataHub_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    MonitorRelayDataHub_exe_LogSession = log_RegComponent("MonitorRelayDataHub_exe", &MonitorRelayDataHub_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_MonitorRelayDataHubComponent.so");
