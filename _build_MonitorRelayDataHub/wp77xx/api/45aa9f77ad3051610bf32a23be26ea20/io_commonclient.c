 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(io_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    io_TriggerPushHandlerFunc_t _handlerRef_ifgen_io_AddTriggerPushHandler = (io_TriggerPushHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    io_BooleanPushHandlerFunc_t _handlerRef_ifgen_io_AddBooleanPushHandler = (io_BooleanPushHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    io_NumericPushHandlerFunc_t _handlerRef_ifgen_io_AddNumericPushHandler = (io_NumericPushHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    io_StringPushHandlerFunc_t _handlerRef_ifgen_io_AddStringPushHandler = (io_StringPushHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    io_JsonPushHandlerFunc_t _handlerRef_ifgen_io_AddJsonPushHandler = (io_JsonPushHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    io_UpdateStartEndHandlerFunc_t _handlerRef_ifgen_io_AddUpdateStartEndHandler = (io_UpdateStartEndHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
