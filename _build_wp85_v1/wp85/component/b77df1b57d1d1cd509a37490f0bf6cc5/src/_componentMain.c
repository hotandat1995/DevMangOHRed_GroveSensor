...
extern const char* _powerMgr_le_shutdown_ServiceInstanceName;
const char** le_shutdown_ServiceInstanceNamePtr = &_powerMgr_le_shutdown_ServiceInstanceName;
void le_shutdown_AdvertiseService(void);
...
__attribute__((weak))
void _powerMgr_COMPONENT_INIT_ONCE(void)
{
}
...
// Queue the default component's COMPONENT_INIT_ONCE to Event Loop.
    event_QueueComponentInit(_powerMgr_COMPONENT_INIT_ONCE);
