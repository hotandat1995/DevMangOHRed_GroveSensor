 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_gpioPin31_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_gpioPin31_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_gpioPin31_ServerHandlers, HIGH_SERVER_DATA_COUNT);
