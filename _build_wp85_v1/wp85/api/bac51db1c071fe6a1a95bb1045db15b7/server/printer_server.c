 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(printer_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(printer_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(printer_ServerData,
    ...
    _HandlerRefMap = le_ref_InitStaticMap(printer_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_printer_Print :
            Handle_printer_Print(msgRef);
            break;
