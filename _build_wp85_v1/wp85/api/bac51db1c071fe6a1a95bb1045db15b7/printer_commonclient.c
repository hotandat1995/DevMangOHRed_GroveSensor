 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(printer_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(printer_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(printer_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(printer_ClientHandlers,
                                                  HIGH_CLIENT_DATA_COUNT);
        }
...
)
{
    ...
    if ( strnlen(message, 100) > 100 )
    {
        LE_FATAL("strnlen(message, 100) > 100");
    }
