 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_coap_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_coap_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_coap_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
static void AsyncResponse_le_coap_Push
(
...
)
{
    ...
    {
        LE_FATAL("Handler passed to le_coap_Push() can't be called more than once");
    }
...
)
{
    ...
    _result  = le_coap_Push ( 
        ...
        streamStatus, 
        payloadPtr, 
        payloadSize, AsyncResponse_le_coap_Push, 
        contextPtr );
