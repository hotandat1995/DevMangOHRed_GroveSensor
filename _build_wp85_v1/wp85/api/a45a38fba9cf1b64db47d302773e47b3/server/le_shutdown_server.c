...
#include "le_shutdown_server.h"
#include "le_shutdown_messages.h"
#include "le_shutdown_service.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_shutdown_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_shutdown_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_shutdown_ServerData,
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_shutdown_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
static void Handle_le_shutdown_IssueFast
(
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_shutdown_IssueFast :
            Handle_le_shutdown_IssueFast(msgRef);
            break;
