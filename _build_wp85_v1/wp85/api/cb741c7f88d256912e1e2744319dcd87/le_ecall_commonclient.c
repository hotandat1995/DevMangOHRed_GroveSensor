 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_ecall_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_ecall_StateChangeHandlerFunc_t _handlerRef_ifgen_le_ecall_AddStateChangeHandler = (le_ecall_StateChangeHandlerFunc_t)_clientDataPtr->handlerPtr;
