 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_atServer_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_atServer_CommandHandlerFunc_t _handlerRef_ifgen_le_atServer_AddCommandHandler = (le_atServer_CommandHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_atServer_GetTextCallbackFunc_t _handlerRef_ifgen_le_atServer_GetTextAsync = (le_atServer_GetTextCallbackFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
