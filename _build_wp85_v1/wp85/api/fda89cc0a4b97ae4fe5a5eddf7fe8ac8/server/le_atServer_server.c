 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_atServer_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_atServer_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_atServer_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    {
        LE_DEBUG("Adjusting parameterSize from %" PRIuS " to 127", parameterSize);
        parameterSize = 127;
    }
