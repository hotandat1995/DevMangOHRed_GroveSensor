 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_voicecall_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_voicecall_StateHandlerFunc_t _handlerRef_ifgen_le_voicecall_AddStateHandler = (le_voicecall_StateHandlerFunc_t)_clientDataPtr->handlerPtr;
