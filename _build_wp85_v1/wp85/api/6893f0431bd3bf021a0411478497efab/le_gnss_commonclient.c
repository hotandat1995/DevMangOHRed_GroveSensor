 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_gnss_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_gnss_PositionHandlerFunc_t _handlerRef_ifgen_le_gnss_AddPositionHandler = (le_gnss_PositionHandlerFunc_t)_clientDataPtr->handlerPtr;
