 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_instStat_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_instStat_AppInstallHandlerFunc_t _handlerRef_ifgen_le_instStat_AddAppInstallEventHandler = (le_instStat_AppInstallHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_instStat_AppUninstallHandlerFunc_t _handlerRef_ifgen_le_instStat_AddAppUninstallEventHandler = (le_instStat_AppUninstallHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
