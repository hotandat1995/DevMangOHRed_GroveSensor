 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(secStoreGlobal_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(secStoreGlobal_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(secStoreGlobal_ServerData,
    ...
    _HandlerRefMap = le_ref_InitStaticMap(secStoreGlobal_ServerHandlers, HIGH_SERVER_DATA_COUNT);
