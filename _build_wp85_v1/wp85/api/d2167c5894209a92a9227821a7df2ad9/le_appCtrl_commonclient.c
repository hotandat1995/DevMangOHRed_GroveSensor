 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_appCtrl_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_appCtrl_TraceAttachHandlerFunc_t _handlerRef_ifgen_le_appCtrl_AddTraceAttachHandler = (le_appCtrl_TraceAttachHandlerFunc_t)_clientDataPtr->handlerPtr;
