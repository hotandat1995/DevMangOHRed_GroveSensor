 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_smsInbox1_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_smsInbox1_RxMessageHandlerFunc_t _handlerRef_ifgen_le_smsInbox1_AddRxMessageHandler = (le_smsInbox1_RxMessageHandlerFunc_t)_clientDataPtr->handlerPtr;
