 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_update_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_update_ProgressHandlerFunc_t _handlerRef_ifgen_le_update_AddProgressHandler = (le_update_ProgressHandlerFunc_t)_clientDataPtr->handlerPtr;
