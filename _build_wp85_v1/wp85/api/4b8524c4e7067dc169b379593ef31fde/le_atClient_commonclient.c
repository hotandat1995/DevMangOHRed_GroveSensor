 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_atClient_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_atClient_UnsolicitedResponseHandlerFunc_t _handlerRef_ifgen_le_atClient_AddUnsolicitedResponseHandler = (le_atClient_UnsolicitedResponseHandlerFunc_t)_clientDataPtr->handlerPtr;
