 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_atClient_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_atClient_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_atClient_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    {
        LE_DEBUG("Adjusting intermediateRspSize from %" PRIuS " to 512", intermediateRspSize);
    ...
    // Define storage for output parameters
    char intermediateRspBuffer[513] = { 0 };
...
)
{
    ...
    {
        LE_DEBUG("Adjusting finalRspSize from %" PRIuS " to 512", finalRspSize);
        finalRspSize = 512;
    }
