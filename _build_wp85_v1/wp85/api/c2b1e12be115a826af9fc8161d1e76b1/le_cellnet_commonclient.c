 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_cellnet_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_cellnet_StateHandlerFunc_t _handlerRef_ifgen_le_cellnet_AddStateEventHandler = (le_cellnet_StateHandlerFunc_t)_clientDataPtr->handlerPtr;
