...
// Startup code for the executable 'helloServer'.
...
LE_SHARED const char* _printServer_printer_ServiceInstanceName = "printer";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t helloServer_exe_LogSession;
LE_SHARED le_log_Level_t* helloServer_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    helloServer_exe_LogSession = log_RegComponent("helloServer_exe", &helloServer_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_printServer.so");
