...
// Startup code for the executable 'helloClient'.
...
LE_SHARED const char* _printClient_printer_ServiceInstanceName = "helloClient.printClient.printer";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t helloClient_exe_LogSession;
LE_SHARED le_log_Level_t* helloClient_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    helloClient_exe_LogSession = log_RegComponent("helloClient_exe", &helloClient_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_printClient.so");
