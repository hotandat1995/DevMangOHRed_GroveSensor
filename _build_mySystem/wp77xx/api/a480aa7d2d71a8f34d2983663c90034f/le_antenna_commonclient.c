 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_antenna_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_antenna_StatusHandlerFunc_t _handlerRef_ifgen_le_antenna_AddStatusEventHandler = (le_antenna_StatusHandlerFunc_t)_clientDataPtr->handlerPtr;
