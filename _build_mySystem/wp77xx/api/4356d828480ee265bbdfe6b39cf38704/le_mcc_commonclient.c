 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_mcc_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_mcc_CallEventHandlerFunc_t _handlerRef_ifgen_le_mcc_AddCallEventHandler = (le_mcc_CallEventHandlerFunc_t)_clientDataPtr->handlerPtr;
