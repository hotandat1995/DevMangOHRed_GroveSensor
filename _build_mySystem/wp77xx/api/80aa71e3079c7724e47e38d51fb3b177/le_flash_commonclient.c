 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_flash_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_flash_BadImageDetectionHandlerFunc_t _handlerRef_ifgen_le_flash_AddBadImageDetectionHandler = (le_flash_BadImageDetectionHandlerFunc_t)_clientDataPtr->handlerPtr;
