 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_temp_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_temp_ThresholdEventHandlerFunc_t _handlerRef_ifgen_le_temp_AddThresholdEventHandler = (le_temp_ThresholdEventHandlerFunc_t)_clientDataPtr->handlerPtr;
