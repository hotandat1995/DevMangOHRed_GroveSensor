 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_mdmCfg_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_mdmCfg_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_mdmCfg_ServerData,
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_mdmCfg_ServerHandlers, HIGH_SERVER_DATA_COUNT);
