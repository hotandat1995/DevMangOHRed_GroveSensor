 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_ips_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_ips_ThresholdEventHandlerFunc_t _handlerRef_ifgen_le_ips_AddThresholdEventHandler = (le_ips_ThresholdEventHandlerFunc_t)_clientDataPtr->handlerPtr;
