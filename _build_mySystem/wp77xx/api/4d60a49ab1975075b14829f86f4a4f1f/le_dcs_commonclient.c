 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_dcs_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_dcs_EventHandlerFunc_t _handlerRef_ifgen_le_dcs_AddEventHandler = (le_dcs_EventHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_dcs_GetChannelsHandlerFunc_t _handlerRef_ifgen_le_dcs_GetChannels = (le_dcs_GetChannelsHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
