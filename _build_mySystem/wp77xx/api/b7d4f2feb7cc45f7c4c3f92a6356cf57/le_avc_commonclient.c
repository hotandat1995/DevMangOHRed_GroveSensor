 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_avc_ClientHandlers, HIGH_CLIENT_DATA_COUNT);
...
)
{
    ...
    le_avc_StatusHandlerFunc_t _handlerRef_ifgen_le_avc_AddStatusEventHandler = (le_avc_StatusHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avc_SessionRequestHandlerFunc_t _handlerRef_ifgen_le_avc_AddSessionRequestEventHandler = (le_avc_SessionRequestHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avc_CommInfoHandlerFunc_t _handlerRef_ifgen_le_avc_AddCommInfoHandler = (le_avc_CommInfoHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
