 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(secStoreAdmin_ServerData, HIGH_SERVER_DATA_COUNT, sizeof(_ServerData_t));
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(secStoreAdmin_ServerHandlers, HIGH_SERVER_DATA_COUNT);
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(secStoreAdmin_ServerData,
    ...
    _HandlerRefMap = le_ref_InitStaticMap(secStoreAdmin_ServerHandlers, HIGH_SERVER_DATA_COUNT);
